...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-20 md:py-24 bg-neutral-950 border-b border-neutral-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 border-l-2 border-red-600 pl-4 py-2 bg-neutral-900/40 rounded-r-lg">
              <h3 className="text-sm font-bold uppercase tracking-wider text-neutral-100">Our Vision</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="bg-neutral-900 border-neutral-800 rounded-2xl">
              <CardContent className="p-6">
                ...
                <p className="text-xs text-neutral-300 mt-1">Amitgram, Inter College, Dudhli Rd, Jolly Grant &amp; Doiwala.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-neutral-900 border-neutral-800 rounded-2xl">
              <CardContent className="p-6">
                ...
                <p className="text-xs text-neutral-300 mt-1">Rated 4.8 to 5.0 stars across Google Maps.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-neutral-900 border-neutral-800 rounded-2xl">
              <CardContent className="p-6">
                ...
                <p className="text-xs text-neutral-300 mt-1">24-hour access available at Dobhal Complex branch.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-neutral-900 border-neutral-800 rounded-2xl">
              <CardContent className="p-6">
                ...
                <p className="text-xs text-neutral-300 mt-1">Individualized calorie goals, macro plans &amp; lift forms.</p>
              </CardContent>
            </Card>
          </div>
        </div>
