  ...
  return (
    <section className="py-20 bg-neutral-900/40 border-b border-neutral-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <Card className="bg-neutral-950 border border-neutral-800 rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden">
          {/* Subtle Glow */}
          <div className="absolute top-0 right-0 w-56 h-56 bg-red-600/10 blur-[100px] rounded-full pointer-events-none" />

          <div className="text-center max-w-xl mx-auto mb-8">
            <Badge className="bg-red-600 hover:bg-red-600 text-white text-[10px] uppercase font-black px-3 py-1 mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label htmlFor="freetrial-name" className="block text-xs uppercase font-bold text-neutral-300 mb-1.5">
              ...
              <div>
                <label htmlFor="freetrial-phone" className="block text-xs uppercase font-bold text-neutral-300 mb-1.5">
              ...
              <div>
                <label htmlFor="freetrial-branch" className="block text-xs uppercase font-bold text-neutral-300 mb-1.5">
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full bg-red-600 hover:bg-red-700 text-white font-bold uppercase text-xs sm:text-sm tracking-wider py-6 rounded-xl shadow-lg shadow-red-600/30 flex items-center justify-center gap-2 mt-4"
            >
